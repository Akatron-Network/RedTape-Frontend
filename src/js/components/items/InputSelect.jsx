...
export default function InputSelect(props) {
  return (
    <div className='w-full flex flex-row shadow-input'>
      ...
      <select ref={props.reference} onChange={(e) => props.func(e.target.value)}  defaultValue={props.options.length > 0 && props.options[0] !== "Borç" ? props.options[0] : "default"} required className="block w-2/3 min-h-[34px] py-[6px] text-sm text-prussian_blue border border-white bg-white focus:ring-transparent focus:border-shadow_blue">
