...
export default function InputSelect(props) {
  return (
    <div className='w-full flex flex-row shadow-input rounded-md'>
      <span className="w-1/3 min-w-[120px] truncate flex min-h-[34px] justify-center items-center rounded-l-md border border-alica_blue px-1 py-[6px] text-sm bg-indigo_dye text-ghost_white">{props.name}</span>
