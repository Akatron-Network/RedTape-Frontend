...
export default function InputDefaultNoSpan(props) {
  return (
    <div className="relative col-span-2 lg:col-span-1 shadow-input rounded-md">
      <input type={props.type} ref={props.reference} id={props.name} className="block p-2 pb-[.30rem] min-h-[34px] w-full text-prussian_blue text-sm bg-white border border-alica_blue_middle appearance-none placeholder:text-mn_blue focus:border-indigo_dye focus:ring-transparent peer rounded-md" placeholder=" " />
