  ...
  return (
    ...
    <div className="overflow-auto max-h-[639px] shadow-table rounded-md border border-alica_blue">
      <table className="w-full text-sm text-left text-pine_tree">
        ...
        <thead>
          <tr>
            ...
            <th scope="col" className="p-2 w-20 font-normal h-10 text-xs text-ghost_white bg-indigo_dye sticky top-0">
      ...
      <nav className="flex justify-between items-center py-2 px-3 bg-indigo_dye h-10 sticky bottom-0" aria-label="Table navigation">
        ...
        <span className="text-sm font-normal text-steel_blue">Toplam tutar <span className="font-normal text-alica_blue_middle">{CurrencyFormat(table_total)}</span></span>
      </nav>
    </div>
  )
}
