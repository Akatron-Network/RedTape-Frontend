...
export default class Request {
  ...
  constructor(func_name) {
    ...
    this.base_url = "http://redtape-app.akatron.net:999/" + this.func_name; //! Akatron Server
    // this.base_url = "http://127.0.0.1:999/" + this.func_name;
    // this.base_url = "http://93.180.133.185:999/" + this.func_name;   //! Akatron Server
    // this.base_url = "http://192.168.127.16:999/" + this.func_name;   //! Esprint Server
  }
  ...
  static offersRequest() { return new Request(Request.routes.offer) }
