      ...
      <div className='flex'>
        ...
        <div className='flex mb-3 h-max w-fit flex-wrap gap-2'>
          <button onClick={() => tasks_data.showTasks(undefined, tasks_data.admin_check.username)} id="btn_1" type="button" 
            className="flex items-center truncate !overflow-visible relative min-w-10 text-indigo_dye hover:text-white border-b border-indigo_dye hover:bg-indigo_dye transition-all duration-200 min-h-[28px] font-medium rounded-sm text-sm px-5 text-center mr-2 mb-2">
            Tümü
          </button>
          
          <button onClick={() => tasks_data.showTasks({"state": "Tamamlandı"}, tasks_data.admin_check.username)} id="btn_2" type="button" 
            className="flex items-center truncate !overflow-visible relative text-green-700 hover:text-white border-b border-green-700 hover:bg-green-700 transition-all duration-200 min-h-[28px] font-medium rounded-sm text-sm px-5 text-center mr-2 mb-2">
            Tamamlananlar
          </button>
          
          <button onClick={() => tasks_data.showTasks({"state": "Aktif"}, tasks_data.admin_check.username)} id="btn_5" type="button" 
            className="flex items-center truncate !overflow-visible relative text-orange-500 hover:text-white border-b border-orange-600 hover:bg-orange-600 transition-all duration-200 min-h-[28px] font-medium rounded-sm text-sm px-5 text-center mr-2 mb-2">
            Aktif
          ...
          <button onClick={() => tasks_data.showTasks({"state": "İptal Edildi"}, tasks_data.admin_check.username)} id="btn_3" type="button" 
            className="flex items-center truncate !overflow-visible relative text-red-700 hover:text-white border-b border-red-700 hover:bg-red-700 transition-all duration-200 min-h-[28px] font-medium rounded-sm text-sm px-5 text-center mr-2 mb-2">
            İptal Edilenler
          ...
          <button onClick={() => tasks_data.showTasks({"state": "Gecikti"}, tasks_data.admin_check.username)} id="btn_4" type="button" 
            className="flex items-center truncate !overflow-visible relative text-gray-700 hover:text-white border-b border-gray-700 hover:bg-gray-700 transition-all duration-200 min-h-[28px] font-medium rounded-sm text-sm px-5 text-center mr-2 mb-2">
            Gecikenler
          ...
          <button onClick={() => tasks_data.showTasks({"state": "Tahsil Edilmedi"}, tasks_data.admin_check.username)} id="btn_6" type="button" 
            className="flex items-center truncate !overflow-visible relative text-cyan-600 hover:text-white border-b border-cyan-600 hover:bg-cyan-600 transition-all duration-200 h-full min-h-[28px] font-medium rounded-sm text-sm px-5 text-center mr-2 mb-2">
            Tahsil Edilmeyenler
