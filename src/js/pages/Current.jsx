        ...
        <div className='grid grid-cols-1 gap-1 col-span-2 h-fit'>
          ...
          <div className="col-span-1 flex flex-row justify-between">
            ...
            <div className='flex flex-row shadow-input ellipsis h-[30px] rounded-md'>
              ...
              <input onChange={(e) => current_data.filterCurrents(e)} type={"text"} className="w-2/3 min-h-[34px] py-[6px] rounded-r-md bg-white border border-white text-prussian_blue text-sm placeholder:text-mn_blue placeholder:opacity-70 focus:border-shadow_blue focus:ring-transparent block" placeholder="Cari Kod / İsim  ile ara..." required />
            </div>
          </div>
